            ...
            <div className="mx-auto container">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        ...
                        <a
                            className="py-2.5 px-5 h-9 inline-flex items-center gap-2 w-fit bg-primaryCol text-white rounded-full shadow-sm text-xs hover:cursor-pointer mx-auto transition-all  duration-500 hover:bg-black lg:mx-0"
                        >
                            <MdWifiCalling1 />Contact us
                        </a>
                    </div>
                    ...
                    <div className="lg:mx-auto text-left">
                        ...
                        <ul className="text-sm  transition-all duration-500">
                            ...
                            <li className="mb-6">
                                <iframe className="h-24 w-full rounded-xl" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29281.455728507757!2d91.18615988015024!3d23.45389990465368!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37547f249815015d%3A0x549a77e542115f77!2sCumilla!5e0!3m2!1sen!2sbd!4v1717348114318!5m2!1sen!2sbd" referrerPolicy="no-referrer-when-downgrade"></iframe>
                            </li>
                            <li className="mb-6">
                                <a
                                    href="javascript:;"
